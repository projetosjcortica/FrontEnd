import electron, { ipcMain as ipcMain$1, app as app$1, BrowserWindow, dialog } from "electron";
...
const RENDERER_DIST = join(appRoot, "dist");
const PUBLIC_PATH = VITE_DEV_SERVER_URL ? join(appRoot, "public") : RENDERER_DIST;
let win;
...
ipcMain$1.handle("load-data", async () => {
  try {
    return store.get("formData", initialFormData);
  } catch (err) {
...
const logFilePath = join(app$1.getPath("userData"), "error.log");
